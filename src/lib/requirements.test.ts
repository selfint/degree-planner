...
import { loadRequirementsHeader } from './requirements';
...
describe('Requirements parser', () => {
	...
	it('should parse requirements', async () => {
		...
		const requirements = await loadRequirementsHeader(degree, header);

		expect(requirements).toBeDefined();
		expect(requirements).toMatchInlineSnapshot(`
			{
			  "core": {
			    "courses": [
			      "104031",
